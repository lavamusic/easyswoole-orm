...
use EasySwoole\ORM\Collection\BaseCollection;
...
abstract class AbstractModel implements ArrayAccess, JsonSerializable
{
     ...
     * @param null $where
     *
     * @return CursorInterface|false|mixed|null
     * @throws Exception
     * @throws \Throwable
     * @author: hlh XueSi <1592328848@qq.com>
     * @date  : 2022/12/8 10:00 上午
     */
     ...
     * @param null $where
     *
     * @return CursorInterface|false|mixed
     * @throws Exception
     * @throws \Throwable
     * @author: hlh XueSi <1592328848@qq.com>
     * @date  : 2022/12/8 10:01 上午
     */
    public function _all($where = null)
    {
        $builder = new QueryBuilder;
        $builder = PreProcess::mappingWhere($builder, $where, $this);
        $this->preHandleQueryBuilder($builder);
    ...
    private function queryPolymerization($type, $field = null)
    {
        ...
        if (is_object($res[0]) && isset($res[0]->$fields)) {
            return $res[0]->$fields;
        }

        if (is_array($res[0]) && isset($res[0][$fields])) {
            return $res[0][$fields];
        }
